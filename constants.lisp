...
(defconstant +CERT-STORE-PROV-MSG+                 1)
(defconstant +CERT-STORE-PROV-MEMORY+              2)
(defconstant +CERT-STORE-PROV-FILE+                3)
(defconstant +CERT-STORE-PROV-REG+                 4)
(defconstant +CERT-STORE-PROV-PKCS7+               5)
(defconstant +CERT-STORE-PROV-SERIALIZED+          6)
(defconstant +CERT-STORE-PROV-FILENAME-A+          7)
(defconstant +CERT-STORE-PROV-FILENAME-W+          8)
(defconstant +CERT-STORE-PROV-SYSTEM-A+            9)
(defconstant +CERT-STORE-PROV-SYSTEM-W+            10)
(defconstant +CERT-STORE-PROV-COLLECTION+          11)
(defconstant +CERT-STORE-PROV-SYSTEM-REGISTRY-A+   12)
(defconstant +CERT-STORE-PROV-SYSTEM-REGISTRY-W+   13)
(defconstant +CERT-STORE-PROV-PHYSICAL-W+          14)

(defconstant +CERT-STORE-NO-CRYPT-RELEASE-FLAG+                #x00000001)
(defconstant +CERT-STORE-SET-LOCALIZED-NAME-FLAG+              #x00000002)
(defconstant +CERT-STORE-DEFER-CLOSE-UNTIL-LAST-FREE-FLAG+     #x00000004)
(defconstant +CERT-STORE-DELETE-FLAG+                          #x00000010)
(defconstant +CERT-STORE-UNSAFE-PHYSICAL-FLAG+                 #x00000020)
(defconstant +CERT-STORE-SHARE-STORE-FLAG+                     #x00000040)
(defconstant +CERT-STORE-SHARE-CONTEXT-FLAG+                   #x00000080)
(defconstant +CERT-STORE-MANIFOLD-FLAG+                        #x00000100)
(defconstant +CERT-STORE-ENUM-ARCHIVED-FLAG+                   #x00000200)
(defconstant +CERT-STORE-UPDATE-KEYID-FLAG+                    #x00000400)
(defconstant +CERT-STORE-BACKUP-RESTORE-FLAG+                  #x00000800)
(defconstant +CERT-STORE-READONLY-FLAG+                        #x00008000)
(defconstant +CERT-STORE-OPEN-EXISTING-FLAG+                   #x00004000)
